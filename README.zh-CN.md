...
![AI-Apktool 功能树](docs/assets/feature-tree.zh.png)

<sub>由 [`scripts/feature_tree.py`](scripts/feature_tree.py)（纯 Pillow，零外部依赖）渲染——执行 `python3 scripts/feature_tree.py --lang zh` 可重新生成。</sub>
